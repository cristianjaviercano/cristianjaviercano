...
# Applied Technology Management - Course Introduction
...
mindmap
  root((Course Content))
    Module 1 Fundamentals
      Innovation Types & Processes
      Open Innovation
      R&D Stages
      Tech Management Tools
      Innovation Culture
    Module 2 PMI Approach
      Process Groups Init to Close
      Knowledge Areas
      Agile Scrum Kanban
...
```mermaid
flowchart LR
    A["Team Formation"] --> B["Real Problem Diagnosis"]
    B --> C["Design & Prototyping"]
    C --> D["External Validation"]
    D --> E["SILOGÉ Project Fair"]
    
    style A fill:#f9f,stroke:#333,stroke-width:2px
    style E fill:#bbf,stroke:#333,stroke-width:2px
```

* **Teamwork**: Students will organize into teams of 3-4 members. Each team must identify a real company (or a validated realistic case study) and a specific industrial problem that can be solved through the application of technology.
* **Integrated Project Cycle**: Teams will follow a project cycle from problem identification to the design, prototyping, and evaluation of a technological solution. This cycle will be guided by the PMI phases.
* **Open Innovation Philosophy**: Interaction with the real productive environment will be encouraged. This implies that teams must approach companies, understand their needs, and validate their proposals with external stakeholders (mentors, experts, company employees).
* **Use of Technological Tools**: Throughout the course, students will actively apply the mentioned tools: block-based programming, Arduino, Anylogic, and Python, in constructing their solution.
* **Theoretical-Practical Sessions**: Each weekly session will combine the explanation of theoretical concepts with practical workshops and guided work on team projects.
* **SILOGÉ Research Group Integration**: Integration with the SILOGÉ research group will be sought through mentoring by advanced students from the group, participation in events, and the possibility for high-potential course projects to continue development within the group.
* **Constant Feedback**: Regular sessions will be held for progress presentations and feedback between teams and with the instructor, promoting iterative learning.

***

### Student Guide

**Dear Industrial Engineering Student,**
